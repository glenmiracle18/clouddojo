  ...
  return (
    <>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {draftTimestamp && draftManager.getTimeAgo(draftTimestamp)}. Would
      ...
      <div className="flex h-screen w-full">
        ...
        <div
          className={`
          shrink-0 overflow-y-auto transition-all duration-300 flex flex-col
        ...
        >
          ...
          <div className={`pt-8 flex-1 ${isSidebarCollapsed ? "px-3" : "p-6"}`}>
            <div>
            ...
            {/* Save Draft Button */}
            <div
              className={`mt-auto pt-6 pb-6 ${isSidebarCollapsed ? "" : "px-0"}`}
            >
              <Button
                variant="outline"
                onClick={saveDraft}
                disabled={!basicInfo && !content && !steps && !categories}
                className={`w-full group ${isSidebarCollapsed ? "px-0" : ""}`}
              >
                {isSidebarCollapsed ? (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    height="18px"
                    viewBox="0 0 18 18"
                    className="transition-colors group-hover:text-emerald-600 dark:group-hover:text-emerald-400"
                  >
                    <path
                  ...
                  <>
                    <svg
                      ...
                      height="18px"
                      viewBox="0 0 18 18"
                      className="mr-2 transition-colors group-hover:text-emerald-600 dark:group-hover:text-emerald-400"
                    >
                      <path
                        d="m10.25,4h-5.5c-1.517,0-2.75,1.233-2.75,2.75v9.5c0,.283.159.542.412.669.252.128.555.102.783-.065l4.305-3.172,4.305,3.172c.132.097.288.146.445.146.115,0,.231-.026.338-.081.253-.127.412-.387.412-.669V6.75c0-1.517-1.233-2.75-2.75-2.75Z"
                        strokeWidth="0"
