...
import IconHeadsetFill18 from "./icons/headset-icon";
import IconPointerOutlineDuo18 from "./icons/pointer-outline";
...
export default function HeroSection() {
  ...
  const mascotSrc =
    theme === "light"
      ? "/images/extras/sensie-black.png"
      : "/images/extras/sensie-brown.png";
            ...
            >
              {isSignedIn ? (
                ...
                <div className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
                  ...
                  <div className="relative flex space-x-2 items-center z-10 rounded-full bg-gradient-to-b from-emerald-600 to-emerald-700 py-3 px-6 ring-1 ring-white/10 w-auto ">
                    <SignInButton
                      mode="modal"
                      appearance={{
                    ...
                    >
                      <div className="flex items-center">
                        <span className="text-sm flex items-center overflow-hidden relative">
                          ...
                          <IconPointerOutlineDuo18 className="h-5  w-5 text-foreground-primary ml-[84px] absolute group-hover:translate-y-10 transition-all duration-500" />
                          <IconPointerOutlineDuo18 className="h-5 w-5  text-foreground-primary ml-[84px] absolute -translate-y-10 group-hover:translate-y-0 transition-all duration-500" />
                        </span>
                      </div>
                    </SignInButton>
                  </div>
              ...
              >
                <Button
                  variant="glass"
                  size="lg"
                  className="rounded-full py-5 hover:text-primary hover:border-primary"
                >
                  Support
                  <IconHeadsetFill18 className="ml-2 inline-block h-4 w-4" />
                </Button>
              </Link>
            </motion.div>
