...
<Alert type="success" title="Next step">
If you want, I can convert the Quickstart into a downloadable checklist or create a guided interactive lab (step-by-step commands with expected output) you can follow in your terminal.
</Alert>
